...
namespace Azure.ResourceManager.Samples.Common
{
    public static class Utilities
    {
        ...
        public static void PrintNetworkSecurityGroup(NetworkSecurityGroupResource resource)
        {
            ...
            nsgOutput.Append("NSG: ").Append(resource.Id)
                    ...
                    .Append("\n\tTags: ").Append(FormatDictionary(resource.Data.Tags));

            // Output security rules
            foreach (var rule in resource.Data.SecurityRules)
            {
